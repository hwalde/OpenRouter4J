 ...
 * tool_choice} must also be omitted, left at the default {@code "auto"}, or
 * set to the {@code allowed_tools} form (the Responses builder offers it via
 * {@code toolChoiceAllowedTools}; this chat example has no equivalent).
 */
