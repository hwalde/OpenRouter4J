...
* Preset-based inference: `preset("slug")` runs the completion against a stored OpenRouter preset (request fields shallow-merge server-side and win over the preset; `model("@preset/slug")` works verbatim too)
